        ...
        return (
            <div className="bg-brand-bg-alt py-40">
                <div className="container mx-auto px-6 text-center">
                    ...
                    <Link to="/articles" className="bg-brand-gold text-white font-bold py-3 px-8 rounded-full hover:bg-brand-gold-darker transition-colors duration-300">
                        View All Articles
                    </Link>
                </div>
            </div>
    ...
    return (
        <div className="bg-brand-light py-20 pt-32">
            <div className="container mx-auto px-6 max-w-4xl">
                 <button onClick={() => navigate('/articles')} className="text-brand-gold hover:text-brand-dark font-semibold mb-8 inline-flex items-center group">
